...
lam_  = [lambda_marker_genes] * 3 + lam_ # marker
lam_ = lam_ + [lam * 2/3] * num_unann # unann
...
scvi_palava.train(850, gradient_clip_val = 1e4, train_size = 1.0, batch_size = 100, plan_kwargs = plan_kwargs )
