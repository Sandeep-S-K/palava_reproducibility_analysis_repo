...
# Access the data directorypalva
...
scvi_palava = SCVI_palava(adata, n_annotated_latent =  len(pathways_bool), n_unannotated_latent =num_facs_unann, nonlinear = nonlinear, other_n_latent = 20, lam_lst = lam, pathways_bool = pathways_bool, dispersion = 'gene', palava_n_hidden = 0, palava_n_layers = 0,  n_layers = 3, use_batch_norm = 'none',use_layer_norm = 'none', momentum_train = 0.1,  weight_decay_train = 0.0001, decoder_bias= False,  non_neg_decoder =True)
