...
lam = [lambda_] * num_facs_ann + [lambda_/2] * num_facs_unann
...
np.save('intermediate_results/palava_'+'lambda_'+args.lambda_+'_results_'+name_of_anndata.replace('.h5ad','.npy'), results, allow_pickle=True)
